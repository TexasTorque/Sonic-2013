...
public class TrapezoidalProfile {
    ...
    public void generateAccelerationProfile(double actualDistance, double actualSpeed, double goalSpeed) {
        ...
        if (actualDistance > 0.0) {
            ...
            generateAccelerationProfile(-actualDistance, -actualSpeed, -goalSpeed);
    ...
    public void update(double actualDistance, double actualSpeed, double dt) {
        double timeLeft = dt;
